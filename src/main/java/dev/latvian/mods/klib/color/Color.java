...
public record Color(int argb) {
	...
	public static final DataType<Color> DATA_TYPE = DataType.of(CODEC, STREAM_CODEC);
	public static final DataType<Color> SOLID_DATA_TYPE = DataType.of(SOLID_CODEC, SOLID_STREAM_CODEC);
